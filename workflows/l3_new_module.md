...
| 音视频管线 | [av_pipeline_sync.txt](../prompts/av_pipeline_sync.txt) + [av_codec_format.txt](../prompts/av_codec_format.txt) + [audio_dma_pingpong.txt](../prompts/audio_dma_pingpong.txt) | [good_av_pipeline_sync.c](../examples/good_av_pipeline_sync.c) + [good_media_format_contract.c](../examples/good_media_format_contract.c) |
