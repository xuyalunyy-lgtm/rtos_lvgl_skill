...
1. 从 [页面规划模板](../templates/lvgl_page_plan.json) 摘取当前页面的显示预算、UI owner、根页/父级、生命周期、资源策略和导航 guard；多页或动态页面必须先运行 `python tools/lvgl_page_plan_checker.py lvgl_page_plan.json`。
