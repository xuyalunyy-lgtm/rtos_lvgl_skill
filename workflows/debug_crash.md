...
| DMA 后读到旧 PCM / Camera 旧帧 / LCD flush 局部错乱 | C28.1–C28.5, C4.8, C23.4 | [av_dma_buffer_lifecycle.txt](../prompts/av_dma_buffer_lifecycle.txt) · [audio_dma_pingpong.txt](../prompts/audio_dma_pingpong.txt) | [bad_av_dma_buffer_lifecycle.c](../examples/bad_av_dma_buffer_lifecycle.c) · `av_dma_buffer_checker.py` |
| 网络抖动后爆音 / 音频 underrun / 恢复慢 | C27.2, C27.4, C27.5, C20.1 | [av_clock_jitter.txt](../prompts/av_clock_jitter.txt) · [network_resilience.txt](../prompts/network_resilience.txt) | [bad_av_clock_jitter.c](../examples/bad_av_clock_jitter.c) · `av_clock_jitter_checker.py` |
