...
- **带屏音视频产品**：camera/video preview、音画同步、掉帧/爆音、长时间漂移 → [av_pipeline_sync.txt](../prompts/av_pipeline_sync.txt)（C25）+ [av_codec_format.txt](../prompts/av_codec_format.txt)（C26）+ [av_clock_jitter.txt](../prompts/av_clock_jitter.txt)（C27）
