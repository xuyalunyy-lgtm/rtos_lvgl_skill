...
def main() -> int:
    ...
    print("\n[3/9] checker registry")
    errors.extend(check_checker_registry())

    print("\n[4/9] runtime distribution boundary")
