...
def main() -> int:
    ...
    print("\n[3/11] checker registry")
    errors.extend(check_checker_registry())

    print("\n[4/11] runtime distribution boundary")
