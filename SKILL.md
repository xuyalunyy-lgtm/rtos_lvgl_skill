...
**平台专档**（Step 1 加载）：[esp32](platforms/esp32.md) | [stm32](platforms/stm32.md) | [jl](platforms/jl.md) | [bk](platforms/bk.md)
...
`mvp_codegen` 多次生成时，须**手动合并** `app_test_config.h` 中的各 `APP_TEST_MODE_*` 宏。
