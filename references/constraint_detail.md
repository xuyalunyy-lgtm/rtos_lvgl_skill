...
| C32.4 | init/connect/handshake/decode/render/flush 等阶段必须保留 max time 或最近耗时 | P2 | 人工 | [timeout_lifecycle_observability.txt](../prompts/timeout_lifecycle_observability.txt) | 性能尖峰不可定位 |
