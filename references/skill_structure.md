...
> C1–C43 是硬性约束域；软件架构设计是场景 prompt，可与 C29-C43 联动但不单独占用约束编号。
...
| 平台 | 文件 | 必选约束 | 特性 |
|------|------|----------|------|
| ESP32 | `esp32.json` | C1-C4,C7-C9,C11-C12,C14-C15,C23,C25-C43 | WiFi+BLE+LVGL+I2S+Camera, 双核, PSRAM |
| STM32 | `stm32.json` | C2-C4,C7-C9,C11-C12,C14-C15,C23,C29-C43 | LVGL+I2S+TLS, 单核 Cortex-M |
| JL | `jl.json` | C1-C4,C6-C15,C23,C25-C43 | WiFi+BLE+LVGL+I2S+语音/视频, 双核 RISC-V |
| BK | `bk.json` | C1-C4,C6-C15,C17,C23,C25-C43 | WiFi+BLE+LVGL+AVDK音频+语音/视频, 双核 IPC |
