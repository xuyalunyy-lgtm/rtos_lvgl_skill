#include "lvgl.h"
#include "ui_page_dashboard_page.h"
...
static lv_obj_t *s_region_28 = NULL;
static lv_obj_t *s_region_29 = NULL;
static lv_obj_t *s_region_30 = NULL;
static lv_obj_t *s_region_31 = NULL;
static lv_obj_t *s_region_32 = NULL;
static lv_obj_t *s_region_33 = NULL;
static lv_obj_t *s_region_34 = NULL;
static lv_obj_t *s_region_35 = NULL;
static lv_obj_t *s_region_36 = NULL;
static lv_obj_t *s_region_37 = NULL;
...
lv_obj_t *ui_page_dashboard_page_create(lv_obj_t *parent)
{
    ...
    s_region_27 = lv_obj_create(s_root);

    s_region_28 = lv_obj_create(s_root);

    s_region_29 = lv_obj_create(s_root);

    s_region_30 = lv_obj_create(s_root);

    s_region_31 = lv_obj_create(s_root);

    s_region_32 = lv_obj_create(s_root);

    s_region_33 = lv_obj_create(s_root);

    s_region_34 = lv_obj_create(s_root);

    s_region_35 = lv_obj_create(s_root);

    s_region_36 = lv_obj_create(s_root);

    s_region_37 = lv_obj_create(s_root);
