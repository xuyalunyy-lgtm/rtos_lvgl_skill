#!/usr/bin/env python3
"""
Skill forward test runner — verify skill triggering, lazy loading, and output quality.
...
def test_code_review() -> dict:
    ...
    # 2. JSON output contains checkers
...
def test_generate_module() -> dict:
    """Test module generation: module_contract_gen.py --modules"""
...
def test_generate_project() -> dict:
    """Test project generation: project_scaffold.py --preset voice-screen"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Skill forward test runner")
    ...
    if args.json:
        ...
        print(f"\n{'=' * 50}")
        print(f"Summary: {passed_checks}/{total_checks} checks passed, {failed_tests} tests failed")
        print(f"{'=' * 50}")
