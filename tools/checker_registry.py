...
ALL_CHECKERS: tuple[CheckerSpec, ...] = (
    ...
    CheckerSpec("lvgl_frame_rate_checker", "lvgl_frame_rate_checker.py", "lvgl-frame-rate", "batch", ("C23",),
                ...
                suites=("all", "platform"), error_prefix="C23"),
    CheckerSpec("lvgl_page_plan_checker", "lvgl_page_plan_checker.py", "lvgl-page-plan", "batch", ("C1", "C23", "C29", "C33"),
                note="Validates page ownership, navigation, resources, and display budgets before implementation",
                suites=("all", "platform"), error_prefix="C"),
